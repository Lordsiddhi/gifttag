                      ...
                      <div key={index}>
                        {order.cartItems.map((item, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="mt-5 flex flex-col overflow-hidden rounded-xl border  md:flex-row"
                            >
                              {/* main 3  */}
                                ...
                                <div className="p-8">
                                  <ul className="-my-7 divide-y divide-gray-200">
                                    <li className="flex flex-col justify-between space-x-5 py-7 md:flex-row">
                                      <div className="flex flex-1 flex-col sm:flex-row items-stretch">
                                        ...
                                        <div className="ml-5 flex flex-col justify-between mt-4 sm:mt-0">
                                          <div className="flex-1">
