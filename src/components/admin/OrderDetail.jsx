                    ...
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <tr key={index} className="">
                          ...
                          <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-green-600  first:border-l-0  stroke-slate-500 text-slate-500 first-letter:uppercase ">
                            {order.status}
                          </td>
                          ...
                          <td
                            ...
                            className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0  stroke-slate-500 text-slate-500 text-red-500 cursor-pointer "
                          >
                            Delete
                          </td>
                        </tr>
