      ...
      <div className="py-5 flex justify-between items-center">
        ...
        <Link to={"/addproduct"}>
          <Button
            size="lg"
            variant="md"
            className="px-5 py-2 bg-primary text-white  border rounded-lg"
          >
            Add Product
          </Button>
        </Link>
              ...
              return (
                <tr key={index} className="">
                  ...
                  <td
                    ...
                    className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0  stroke-slate-500 text-slate-500 text-green-500 cursor-pointer "
                  >
                    Edit
                  </td>
                  <td
                    onClick={() => deleteProduct(id)}
                    className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0  stroke-slate-500 text-slate-500 text-red-600 cursor-pointer "
                  >
                    Delete
                  </td>
                </tr>
